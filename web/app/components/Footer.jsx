...
export default function Footer() {
  return (
    <footer className="bg-primary flex mt-10 xl:flex-row flex-col">
      <div className="flex justify-between xl:mx-20 max-w-6xl mx-auto xl:py-12 py-6">
        <div className="flex flex-col">

          <div className="flex xl:flex-row xl:justify-center flex-col items-center gap-4 mb-6">
            <Link href="/" className="flex xl:flex-row flex-col items-center hover:underline">
          ...
          <div className="flex justify-between xl:flex-row flex-col gap-5">
            <div className="flex justify-around xl:gap-x-8">
              <nav>
            ...
            <div className="w-0.5 h bg-quaternary xl:block hidden" />
